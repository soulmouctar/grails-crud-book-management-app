...
<!-- Messages -->
    ...
    <g:hasErrors bean="${this.livre}">
        <div class="alert alert-danger">
            <h6 class="mb-2"><i class="fas fa-bug me-2"></i> Erreurs dans le formulaire :</h6>
            <ul class="mb-0 ps-3">
...
<!-- Formulaire dans une carte -->
    <div class="card card-custom">
        <div class="card-header-custom">
            <h5 class="fw-semibold mb-0 text-primary">
                <i class="fas fa-book me-2"></i> Informations sur le livre
            </h5>
        </div>
        ...
        <g:form resource="${this.livre}" method="POST">
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <label class="form-label">Auteur <span class="required-indicator">*</span></label>
                    <input type="text" name="auteur" value="${livre?.auteur}" class="form-control" required />
                </div>

                <div class="col-md-6">
                    <label class="form-label">ISBN <span class="required-indicator">*</span></label>
                    <input type="text" name="isbn" value="${livre?.isbn}" class="form-control" required />
                </div>

                <div class="col-md-6">
                    <label class="form-label">Année de publication <span class="required-indicator">*</span></label>
                    <input type="number" name="anneePublication" value="${livre?.anneePublication}" min="0" max="2030" class="form-control" required />
                </div>

                <div class="col-md-6 form-group">
                    <label class="form-label form-group">Genre</label>
                    <select name="genre" class="form-select form-control" required>
                        ...
                        <option value="programming" ${livre?.genre == 'programming' ? 'selected' : ''}>Programmation</option>
    ...
    <h4 class="fw-bold mb-3"><i class="fas fa-file-import me-2"></i> Importer depuis un fichier XML</h4>

    <g:form action="uploadXml" method="post" enctype="multipart/form-data">
        <div class="card card-custom">
            <div class="row g-4 align-items-end">
                <div class="col-md-5">
                    <label class="form-label">Plusieurs livres</label>
                ...
                <div class="col-md-5">
                    <label class="form-label">Un seul livre</label>
                    <input type="file" name="xmlFile" class="form-control" />
                </div>
                <div class="col-md-1">
